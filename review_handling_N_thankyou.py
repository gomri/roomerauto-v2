...
def fill_in_review_page(driver,url=None):
	...
	insert_credit_number_review = driver.find_element_by_id(REVIEW_PAGE['fill_in_credit_card']['id_selector']).send_keys(REVIEW_PAGE['fill_in_credit_card']['data_to_fill_stripe'])
	insert_credit_expire_date_review = driver.find_element_by_id(REVIEW_PAGE['fill_in_credit_expire_date']['id_selector']).send_keys(REVIEW_PAGE['fill_in_credit_expire_date']['data_to_fill_stripe'])
	insert_credit_expire_year_review = driver.find_element_by_id(REVIEW_PAGE['fill_in_credit_card_epire_year']['id_selector']).send_keys(REVIEW_PAGE['fill_in_credit_card_epire_year']['data_to_fill_stripe'])
	insert_credit_4last_num_review = driver.find_element_by_id(REVIEW_PAGE['fill_in_credit_card_4last_digits']['id_selector']).send_keys(REVIEW_PAGE['fill_in_credit_card_4last_digits']['data_to_fill_stripe'])
